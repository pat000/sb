                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            ...
                                            <td > 
                                             ...
                                             <a  data-target="#edit_resolution{{$ordinance->id}}" data-toggle="modal"   class="btn btn-white btn-sm"><i class="fa fa-folder-o"></i> {{ ( isset($files) && count($files) == 0 ? 'No' : count($files) )}} File (s) </a>
